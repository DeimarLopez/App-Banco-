 ...
 * Generated at: 2021-08-31 20:51:03 UTC
...
import domain.Trans;
import datos.TrasnsDAO;

public final class vistCliCon_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("domain.Trans");
    _jspx_imports_classes.add("datos.TrasnsDAO");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    ArrayList<Trans> fondoss = new ArrayList<>();
    TrasnsDAO tran = new TrasnsDAO();
    Trans tr = new Trans();
    fondoss = tran.fondos(documento);
    for (int f = 0; f < fondoss.size(); f++) {
        tr = fondoss.get(f);
        fondos = tr.getMonto();
    }
    if(fondos == null){
            response.sendRedirect("vistCliMain.jsp");
    }
      ...
      out.write("                        <h3>Consignar</h3>\n");
      out.write("                        <label for=\"password\">CC</label>\n");
      out.write("                        <input type=\"number\" name=\"documento\" value=\"");
      out.print(documento);
      out.write("\" required>\n");
      out.write("                        <label for=\"password\">Monto</label>\n");
      out.write("                        <input type=\"number\" id=\"monto\" name=\"monto\" required>\n");
      out.write("                        <input type=\"submit\" name=\"btnConsig\" class=\"btn\" value=\"Consig\">\n");
      out.write("                        <h4 id=\"p\">Fondos : ");
      out.print(fondos);
      out.write("</h4>\n");
      out.write("                    </form>\n");
      out.write("                </div>\n");
